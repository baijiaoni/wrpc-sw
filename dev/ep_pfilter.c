...
void pfilter_init_default()
{
	...
	pfilter_cmp(6, 0xcafe, 0xffff, MOV, 13);	/* r9 = 1 when ethertype = streamer */
	...
	pfilter_logic3(15, 14, OR, 15, OR, 13);	/* r15 = BOOTP/UDP/IP(unicast|broadcast) or ICMP/IP(unicast) or ARP(broadcast) or PTPv2 */
	...
	pfilter_logic2(11, 1, AND, 4);		/* r11 = streamer broadcast */
	...
	pfilter_logic2(R_CLASS(0), 10, OR, 13); /* class 0: PTP frames => LM32 */
